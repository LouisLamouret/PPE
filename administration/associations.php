        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="./associations.php">Associations</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Récapitulatif des associations</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                               <table class="table table-striped">
                                ...
                                <tbody>
								<?php
                            	$resultat1=$mysqli->query("SELECT association.id_association, association.nom_association, association.icom_association, association.identifiant_association, association.mdp_association, association.interlocuteur_id_interlocuteur, interlocuteur.nom_interlocuteur, interlocuteur.prenom_interlocuteur
								...
								echo '<tr><td>'.$ligne1['id_association']."</td><td>".$ligne1['nom_association']."</td>
								<td>".$ligne1['icom_association']."</td><td>".$ligne1['identifiant_association']."</td>
								<td>".$ligne1['mdp_association']."</td>
								<td>".$ligne1['nom_interlocuteur']." ".$ligne1['prenom_interlocuteur'].'</td>
								<td class="td-actions text-right">
								<a href="edit_association.php?id='.$ligne1['id_association'].'" rel="tooltip" class="btn btn-simple btn-warning btn-icon" data-original-title="Éditer"><i class="ti-pencil-alt"></i></a>
								<a href="?do='.$ligne1['id_association'].'" rel="tooltip" class="btn btn-simple btn-danger btn-icon" data-original-title="Supprimer"><i class="ti-close"></i></a>
								</td>';
								...
								if($row < 1) {
								echo '<td></td><td><td></td><h3>Il n\'y a pas d\'associations.</h3></td><td></td><td></td>';
								}
								
								$do = ($_GET['do']);
								if($do != "") {								
								$requete = ("DELETE FROM association WHERE id_association = '".$do."'");
