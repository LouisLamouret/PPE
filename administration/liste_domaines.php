				...
				<li class="active" class="toggleSubMenu">
                    ...
                    <a href="#">
                        ...
                        <ul class="active" class="subMenu">
							<li class="active"><a href="liste_domaines.php">Liste des domaines</a></li>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="liste_domaines.php">Liste des domaines</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Récapitulatif des domaines</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                               ...
                               <table class="table table-striped">
                            	<thead>
                                	...
                                	<tbody>
                                <?php
                            	$resultat1=$mysqli->query("SELECT * FROM domaine");
								while ($ligne1 =$resultat1->fetch_assoc()) {
								echo '<tr><td>' .$ligne1['id_domaine']."</td><td>".$ligne1['libelle_domaine'].'</td>
								<td class="td-actions text-right">
								<a href="edit_domaine.php?id='.$ligne1['id_domaine'].'" rel="tooltip" class="btn btn-simple btn-warning btn-icon" data-original-title="Éditer"><i class="ti-pencil-alt"></i></a>
								<a href="?do='.$ligne1['id_domaine'].'" rel="tooltip" title class="btn btn-simple btn-danger btn-icon" data-original-title="Supprimer"><i class="ti-close"></i></a>
								</td></tr>';
								}
								
								$row = mysqli_num_rows($resultat1);
								if($row < 1) {
								echo '<td></td><td><td></td><h3>Il n\'y a pas de domaines.</h3></td><td></td><td></td>';
								}
								
								$do = ($_GET['do']);
								if($do != "") {								
								$requete = ("DELETE FROM domaine WHERE id_domaine = '".$do."'");
								$resultat = $mysqli->query($requete);
								$row = mysqli_num_rows($resultat);
 								if($row < 1) {
 								echo '<script>alert("Suppression effectuée avec succès.");</script>';
 								echo '<script LANGUAGE="JavaScript">document.location.href="./liste_domaines.php"</script>';
