        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="liste_formations.php">Liste des formations</a>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Récapitulatif de toutes les formations</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                               ...
                               <table class="table table-striped">
                            	<thead>
                                	...
                                	<tbody>
                                <?php
                            	$resultat1=$mysqli->query("SELECT formation.id_formation, formation.libelle_formation, formation.description_formation, formation.nb_pers_mini_formation, formation.tarif_formation, formation.domaine_id_domaine, domaine.libelle_domaine
								FROM formation, domaine
								WHERE formation.domaine_id_domaine = domaine.id_domaine");
								while ($ligne1 =$resultat1->fetch_assoc()) {
								echo '
								<tr><td>'.$ligne1['id_formation']."</td>
								<td>".$ligne1['libelle_formation']."</td>
								<td>".$ligne1['description_formation']."</td>
								<td>".$ligne1['nb_pers_mini_formation']."</td>
								<td>".$ligne1['tarif_formation']."€</td>
								<td>".$ligne1['libelle_domaine'].'</td>';
								echo '<td class="td-actions text-right">
								<a href="edit_formation.php?id='.$ligne1['id_formation'].'" rel="tooltip" class="btn btn-simple btn-warning btn-icon" data-original-title="Éditer"><i class="ti-pencil-alt"></i></a>
								<a href="?do='.$ligne1['id_formation'].'" rel="tooltip" class="btn btn-simple btn-danger btn-icon" data-original-title="Supprimer"><i class="ti-close"></i></a></td></tr>';
								}
								
								$row = mysqli_num_rows($resultat1);
								if($row < 1) {
								echo '<td></td><td><td></td><h3>Il n\'y a pas de formations.</h3></td><td></td><td></td>';
								}
								
								$do = ($_GET['do']);
								if($do != "") {								
								$requete = ("DELETE FROM formation WHERE id_formation = '".$do."'");
