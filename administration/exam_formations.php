                ...
                <li class="active" class="toggleSubMenu">
                    <a href="#">
                        ...
                        <ul class="active" class="subMenu">
							...
							<li><a href="ajout_formation.php">Ajout d'un formation</a></li>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="exam_formations.php">Examiner les formations</a>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Récapitulatif des 10 prochaines formations</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                               ...
                               <table class="table table-striped">
                            	<thead>
                                	...
                                	<tbody>
                                <?php
                            	$resultat2=$mysqli->query("SELECT DISTINCT *, domaine.libelle_domaine
								FROM formation, session_formation_has_formation, session_formation, domaine
								...
								AND formation.domaine_id_domaine = domaine.id_domaine
								...
								echo '
								<tr><td>' .$ligne2['id_formation']."</td>
								<td>".$ligne2['libelle_formation']."</td>
								<td>".$ligne2['description_formation']."</td>
								<td>".$ligne2['nb_pers_mini_formation']."</td>
								<td>".$ligne2['tarif_formation']."€</td>
								<td>".$ligne2['libelle_domaine'].'</td>
								<td class="td-actions text-right"><a href="formation.php?id='.$ligne2['id_formation'].'" rel="tooltip" class="btn btn-simple btn-info btn-icon" data-original-title="Examiner"><i class="ti-check-box"></i></a></td>';
								}
								?>
                                </tbody>
                               </table>
