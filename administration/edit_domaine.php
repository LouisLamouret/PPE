...
$Id = $_GET['id'];
$requete = ("SELECT * FROM domaine WHERE id_domaine = '".$Id."'");
$dom = $mysqli->query($requete);
$dom = mysqli_fetch_assoc($dom);
if(isset($_POST['newlibelle']) && !empty($_POST['newlibelle']) && $_POST['newlibelle'] != $dom['libelle_domaine']){
$a = $_POST['newlibelle'];
$requete1 = ("UPDATE `domaine` SET `libelle_domaine` = '".$a."' WHERE `id_domaine` = '".$Id."'");
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand">Éditer un domaine</a>
                </div>
         ...
         <div class="content">
            <div class="container-fluid">
				...
				<div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Éditer un domaine</h4>
                            </div>
                            <div class="content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>ID du domaine</label>
                                                <input type="text" class="form-control border-input" name="newid" disabled placeholder="ID du domaine" value="<?php echo $dom['id_domaine']; ?>">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <label>Libellé</label>
                                                <input type="text" class="form-control border-input" name="newlibelle" placeholder="Libellé" value="<?php echo $dom['libelle_domaine']; ?>">
                                            </div>
                                        </div>
