        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="stagiaires.php">Les stagiaires</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Récapitulatif des stagiaires</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                               ...
                               <table class="table table-striped">
                            	<thead>
                                	...
                                	<tbody>
                                <?php
                            	$resultat1=$mysqli->query("
                            	SELECT stagiaire.id_stagiaire, stagiaire.nom_stagiaire, stagiaire.prenom_stagiaire, stagiaire.statut_stagiaire, stagiaire.fonction_stagiaire, stagiaire.repas_stagiaire, stagiaire.interlocuteur_id_interlocuteur, interlocuteur.nom_interlocuteur, interlocuteur.prenom_interlocuteur
								...
								echo '<tr>
								<td>'.$ligne1['id_stagiaire']."</td>
								<td>".$ligne1['nom_stagiaire']."</td>
								<td>".$ligne1['prenom_stagiaire']."</td>";
								if($ligne1['statut_stagiaire'] == "B"){
								echo '<td>Bénevole</td>';
								} else {
								echo '<td>Salarié</td>';
								}
								echo "<td>".$ligne1['fonction_stagiaire']."</td>";
								if($ligne1['repas_stagiaire'] == "O"){
								echo '<td>Oui</td>';
								} else {
								echo '<td>Non</td>';
								}
								echo "<td>".$ligne1['nom_interlocuteur']." ".$ligne1['prenom_interlocuteur']."</td>";
								
								echo '<td class="td-actions text-right">
								<a href="edit_stagiaire.php?id='.$ligne1['id_stagiaire'].'" rel="tooltip" class="btn btn-simple btn-warning btn-icon" data-original-title="Éditer"><i class="ti-pencil-alt"></i></a>
								<a href="?do='.$ligne1['id_stagiaire'].'" rel="tooltip" class="btn btn-simple btn-danger btn-icon" data-original-title="Supprimer"><i class="ti-close"></i></a></td></tr>';

								}
								
								$row = mysqli_num_rows($resultat1);
								if($row < 1) {
								echo '<td></td><td><td></td><h3>Il n\'y a pas de stagiaires.</h3></td><td></td><td></td>';
								}
								
								$do = ($_GET['do']);
								if($do != "") {								
								$requete = ("DELETE FROM stagiaire WHERE id_stagiaire = '".$do."'");
