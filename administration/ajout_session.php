...
if(isset($_POST['_inscription'])){
    ...
    if(empty($_POST['newsession'])) {
                 echo '<script>
   		alert("Le champ date début est vide.");
</script>';
		$failure = true;
    } else {
	      		if($failure == false){
...
$requete15 = ("INSERT INTO session_formation(id_session, date_debut_session) VALUES('', '". $a ."')") or die(mysql_error());
$resultat15 = $mysqli->query($requete15);

      
          mysqli_free_result($resultat15);
              			echo '<script>alert("Session ajoutée avec succès.");</script>';
						echo '<script type=text/javascript>document.location.replace("liste_sessions.php")</script>';
																}
															}
														}
    ?>
				...
				<li class="toggleSubMenu">
                    ...
                    <a href="#">
                        ...
                        <ul class="active" class="subMenu">
							...
							<li class="active"><a href="ajout_session.php">Ajout d'une session</a></li>
   						</ul>
                </li>
                      <li>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="ajout_session.php">Ajouter d'une session</a>
                </div>
                                ...
                                <form method="POST" action="">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control border-input" name="newsession" placeholder="Exemple : 2018-04-20 16:00:00">
                                            </div>
                                        </div>
                                 	</div>
                                
                                    <div class="text-center">
                                        <input type="submit" name="_inscription" value="Ajouter une nouvelle session" class="btn btn-info btn-fill btn-wd">
                                    </div>
