...
$requete15 = ("INSERT INTO domaine(id_domaine, libelle_domaine) VALUES('', '". $a ."')") or die(mysql_error());
$resultat15 = $mysqli->query($requete15);

      
          mysqli_free_result($resultat15);
              			echo '<script>alert("Domaine ajouté avec succès.");</script>';
						echo '<script type=text/javascript>document.location.replace("liste_domaines.php")</script>';
																}
															}
														}
    ?>
				...
				<li class="active" class="toggleSubMenu">
                    ...
                    <a href="#">
                        ...
                        <ul class="active"class="subMenu">
							...
							<li class="active"><a href="ajout_domaine.php">Ajout d'un domaine</a></li>
   						</ul>
                </li>
                                				<li class="toggleSubMenu">
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="ajout_domaine.php">Ajouter d'un domaine</a>
                </div>
         ...
         <div class="content">
            <div class="container-fluid">
				...
				<div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Ajouter un domaine</h4>
                            </div>
                            <div class="content">
                                <form method="POST" action="">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" name="newlibelle" placeholder="Libellé du domaine">
                                            </div>
                                        </div>
                                 	</div>
                                
                                    <div class="text-center">
                                        <input type="submit" name="_inscription" value="Ajouter un nouveau domaine" class="btn btn-info btn-fill btn-wd">
                                    </div>
